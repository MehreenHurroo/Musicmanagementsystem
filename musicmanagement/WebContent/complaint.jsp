...
<b>A mail will be sent to your registered mail address to address the issue.</b></p>
        <hr/>
        <div class="item">
        ...
        <div class="item">
          <p>Complaint details</p>
            ...
            <input type="text" name="complain" placeholder="Enter your complaint here..." />
          </div>
        <b>Our team will get back to you on your registered email address at the time of registration.</b><br>
        <small>By submitting, you declare that all information you have entered is truthful and accurate.</small>
        <div class="btn-block">
          <button type="submit" value="complain">Send</button>
        </div>
      </form>
    </div>
  </body>
